 ...
 * @since 1.11
 */
public final class CustomGoogleAuthCodeReceiver implements VerificationCodeReceiver {
   ...
   * </p>
   */
  public CustomGoogleAuthCodeReceiver() {
   ...
   */
  CustomGoogleAuthCodeReceiver(String host, int port,
   ...
   * @param port Port to use or {@code -1} to select an unused port
   */
  CustomGoogleAuthCodeReceiver(String host, int port, String callbackPath,
      String successLandingPageUrl, String failureLandingPageUrl) {
    this.host = host;
    this.port = port;
  ...
  public void createRedirectUri() throws IOException {
    ...
    redirectUri = "http://" + this.getHost() + ":" + port + callbackPath;
  }
  ...
  public static final class Builder {
     ...
     */
    public CustomGoogleAuthCodeReceiver build() {
      return new CustomGoogleAuthCodeReceiver(host, port, callbackPath,
